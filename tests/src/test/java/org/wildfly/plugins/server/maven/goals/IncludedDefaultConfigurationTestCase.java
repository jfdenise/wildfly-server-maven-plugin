 ...
 * @author jdenise
 */
public class IncludedDefaultConfigurationTestCase extends ServerMojoTest {
    ...
    public void testLayersConfiguration() throws Exception {
        ...
        checkServer(dir, SERVER_DEFAULT_DIR_NAME, 1, true, null, excludedLayers, mojo.recordState);
