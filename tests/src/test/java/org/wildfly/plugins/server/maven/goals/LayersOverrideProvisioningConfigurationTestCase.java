 ...
 * @author jdenise
 */
public class LayersOverrideProvisioningConfigurationTestCase extends ServerMojoTest {
    ...
    public void testLayersOverrideProvisioningConfiguration() throws Exception {
        ...
        checkServer(dir, SERVER_DEFAULT_DIR_NAME, 1, true, layers, null, mojo.recordState, "foobootable", "foobootable2");
